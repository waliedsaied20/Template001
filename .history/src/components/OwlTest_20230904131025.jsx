...
const Slide = ({ name, id, image, pargh , titlePer}) => {
  ...
  return (
    <div ref={refLocation} className={`slide  bg-[#ADD5F8] flex flex-col  items-center w-[350px] max-sm:w-[200px] p-5 h-fit mr-4 ${inView ? 'animate__animated animate__flipInY animate__slow' : ''} `}>
