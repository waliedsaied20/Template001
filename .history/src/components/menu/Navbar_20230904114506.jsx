      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        {isMobileMenuOpen && (
          <ul className="md:hidden space-y-4  ">
            ...
            <li className="relative text-black animate__animated  animate__slideInRight">
              ...
              {/* Dropdown */}
              {isDropdownOpen && (
                <ul className="dropdown-menu z-50 absolute top-0  right-full bg-blue-300 rounded p-2 animate__animated animate__slideInRight">
        ...
        <ul className="hidden md:flex space-x-4">
          ...
          >
            ...
            {/* Dropdown */}
            {isDropdownOpen && (
              <ul className="dropdown-menu absolute top-full h-fit py-5 z-50 left-0 w-fit bg-blue-300 rounded px-3 animate__animated animate__bounceIn animate__slow">
                <li className="text-black cursor-pointer  border p-2 my-2 hover:bg-yellow-300 rounded">
                  <Link to="/1">Product_1</Link>
                </li>
                <li className="text-black cursor-pointer border p-2  my-2 hover:bg-yellow-300 rounded">
