...
const Navbar = () => {
  ...
  return (
    <nav
      className="bg-transparent  text-black overflow-hidden p-4 animate__animated animate__zoomIn animate__slower "
      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        {isMobileMenuOpen && (
          <ul className="md:hidden space-y-4 ">
            ...
            <li className="relative text-black z-40 animate__animated  animate__slideInRight">
              <Link to="/service">
                <button
        ...
        <ul className="hidden md:flex space-x-4">
          ...
          {/* Add dropdown for Services */}
          <li
            className="relative text-black z-40"
