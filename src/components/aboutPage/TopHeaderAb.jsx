  ...
  return (
    <>
      <section className="w-full" ref={refLocation} style={styleBg}>
        <div className="flex max-sm:block max-sm:my-6">
          <div
          ...
          >
            <h2 className="text-6xl font-bold font-slab">About Us </h2>
          ...
          <div
            className={`w-1/2 max-sm:w-full px-5 mx-auto  max-sm:h-fit py-5 max-sm:mx-auto  max-sm:my-6 text-center ${
