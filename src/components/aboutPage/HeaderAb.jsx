    ...
    <>
      <section className="headerAbout !max-sm:bg-cover" ref={refLocation} style={bgStyle}>
        <div>
          <div className="flex">
            <div className="">
              <div className="text-3xl font-slab bg-mainBgBlue">
                <span className="text-mainText1 text-5xl font-bold">→</span>
                <span>Solve your finacial issues</span>
              </div>
              <h1 className="text-6xl  text-mainText1 font-bold ">Visit us</h1>
              <h1 className="text-4xl font-bold text-mainTextBlue">Anytime</h1>
              <p className="w-1/3 text-xl font-slab">
                Keeping your eye on the ball while performing a deep dive on the
                start-up mentality to derive convergence.
              </p>
              <hr className="w-1/2 bg-gray-400 mx-auto h-2 my-4" />
              <div className="grid grid-cols-2 max-sm:grid-cols-1 gap-4">
                <div className={`grid grid-cols-2 grid-rows-2 h-72 max-sm:grid-cols-2 items-center ${inView ? 'animate__animated animate__rotateInDownLeft animate__slow' : ''}`}>
                  <div className="dd01 flex h-fit max-sm:block">
                    ...
                    <div>
                      <h2 className="text-mainTextBlue text-3xl font-bold">
                        London office
                      </h2>
                      <p className="font-slab leading-6 font-medium text-xl">
